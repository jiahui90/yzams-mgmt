...
public class PasswordCheckPanel extends javax.swing.JPanel implements OKCancelPanelListener {
    ...
    public PasswordCheckPanel() {
        ...
        oKCancelPanel.gotoNormalMode();
        userLb.setText(curUser.getName());
    ...
    public boolean showMeForAuth(JComponent parent){
        ...
        NInternalDiag<Boolean, JComponent> diag = new NInternalDiag<Boolean, JComponent>("密码认证", ClientUtils.buildImageIcon("32.png"), this);
    ...
    public boolean showMeForLock(JComponent parent){
        ...
        NInternalDiag<Boolean, JComponent> diag = new NInternalDiag<Boolean, JComponent>("密码认证", ClientUtils.buildImageIcon("password-auth-32.png"), this);
        diag.addNInternalDiagListener(new NInternalDiagListener() {
        ...
        oKCancelPanel.getCancelButton().setVisible(false);
        return diag.showInternalDiag(parent);
    }
    ...
    private void initComponents() {
        ...
        oKCancelPanel = new com.yz.ams.client.OKCancelPanel();
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(oKCancelPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 378, Short.MAX_VALUE)
        );
                ...
                SwingUtilities.invokeLater(new Runnable() {
                    public void run() {
                        if (ClientContext.isPasswordCorrect(new String(pwdTxFd.getPassword()))) {
                            ...
                            oKCancelPanel.gotoErrorMode("密码输入错误，请重新输入");
