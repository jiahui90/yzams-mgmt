/*
 * PreviewPrintVacNotePanel.java
 * 
 * Copyright(c) 2007-2016 by Yingzhi Tech
 * All Rights Reserved
 * 
 * Created at 2016-07-05 17:56:09
 */
 ...
 */
public class PreviewPrintVacationNotePanel2 extends javax.swing.JPanel {
    ...
    /**
     * Creates new form PreviewPrintVacNotePanel
     */
    public PreviewPrintVacationNotePanel2() {
        initComponents();
        initUI();
        initAgent();
    }
    
    public void showMe(JComponent Parent,String userId) {
        applicantId = userId;
        queryNotes();
    ...
    private void queryNotes(){
        ...
        queryVacationNotesAgent.setParameters(applicantId);
    ...
    private void initReport(){
       ...
       lisReport = new ArrayList<>();
        ...
        lisReport.add(mode);
        pane.previewListInfo(lisReport, null, "/com/yz/ams/client/ui/VacationNoteInfoReport.jasper");
    ...
    private void printVacationNotes(List<NoteReportListMode> listModel){
        try {
            ...
            JasperPrint jasperPrint = JasperFillManager.fillReport(PreviewPrintVacationNotePanel2.class.
                    getResourceAsStream("/com/yz/ams/client/ui/VacationNoteInfoReport.jasper"), map, source);
    ...
    private void initComponents() {
        ...
        contentPane.setPreferredSize(new java.awt.Dimension(800, 560));
        contentPane.setLayout(new java.awt.CardLayout());
        contentPane.add(nWaitingPanel1, "WAIT");

        jPanel1.setLayout(new java.awt.BorderLayout());
        contentPane.add(jPanel1, "CONTENT");
