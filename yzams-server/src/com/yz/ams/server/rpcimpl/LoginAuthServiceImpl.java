 ...
 * All Rights Reserved
 * 
 * Created at 2015-03-26 16:37:48
 */
package com.yz.ams.server.rpcimpl;
...
import com.yz.ams.server.util.StaticDataUtil;
import com.yz.ams.util.ErrorCodeFormater;
...
public class LoginAuthServiceImpl implements LoginAuthService {
    ...
    public void auth(String userId, String usmTokenId) throws HttpRPCException {  
        ...
        try {
            verifier = HttpRPC.getService(HttpRPCTokenVerifier.class,
                            new URL(USMSRPCService.getInstance(ProjectConst.USMS_MODULE_ID).getConfig().
                                    getUsmsServerAddr()));
    ...
    @Override
    public USMSOrganization syncUserOrg() throws HttpRPCException {
        return StaticDataUtil.getRootOrg();
    }
}
